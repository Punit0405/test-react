            ...
            datasets: [
                {
                    ...
                    data: [
                        myState?.storage?.usedSpace /
                            myState?.storage?.totalAllowedSpace,
                        myState?.storage?.remainingSpace /
                            myState?.storage?.totalAllowedSpace,
                    ],
                    backgroundColor: ["#EC1A25", "#D9D9D9"],
                    hoverOffset: 10,
                },
            ],
        });
                                        ...
                                        {storage && storage?.usedSpace ? (
                                            <div>
                                                ...
                                                >
                                                    <div
                                                        className={
                                                            styles.cellphoneParent
                                                        }
                                                    >
                                                        <AssetRegisteryChartComp
                                                            percentage={`${(
                                                                storage?.totalAllowedSpace /
                                                                1000
                                                            ).toFixed(2)} GB`}
                                                            backgroundColor="#F9B91B"
                                                            categoryTitle="Total Storage"
                                                        />
                                                    </div>
                                                    <div
                                                        className={
