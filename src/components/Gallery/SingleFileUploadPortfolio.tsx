...
function SingleFileUploadPortfolio({ filedata }: any) {
    ...
    function uploadFile(file: any) {
        if (file) {
            const Key = `portfolio/${portfolioId}/${filedata?.name.replace(/[!@#$%^()&*]/g, "")}`
    ...
    const uploadDone = async (uploadResult: any) => {
        try {
            ...
            const res = await PortFolioFilesSevice.addFiles(data, portfolioId)
...
export default SingleFileUploadPortfolio;